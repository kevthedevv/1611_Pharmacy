...
namespace Pharmacy
{
    public partial class Sales : Form
    {
        ...
        private void button_ViewSalesReport_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select transactionid, total, discount, subtotal, vatable, totaldue, cashtender, change, dateandtime from postotalsalepertransaction where (dateandtime) >='" + dtp_SalesFrom.Text + "' and dateandtime <= '" + dtp_SalesTo.Text + "';", conn);
